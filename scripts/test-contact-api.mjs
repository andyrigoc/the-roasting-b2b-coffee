...
process.env.RESEND_FROM_EMAIL = "The Roasting <samples@theroastingltd.co.uk>";
process.env.ADMIN_EMAIL = "info@theroastingltd.co.uk";
...
assert.deepEqual(sentEmails[0].to, ["info@theroastingltd.co.uk"]);
